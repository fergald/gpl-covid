...
reghdfe D_l_cum_confirmed_cases pck_social_distance school_closure_popw national_lockdown ///
 testing_regime_*, absorb(i.adm1_id i.dow, savefe) cluster(i.adm1_id t) resid  
...
// xtreg D_l_cum_confirmed_cases pck_social_distance school_closure_popw national_lockdown testing_regime_* i.dow, vce(cluster t) fe

areg D_l_cum_confirmed_cases pck_social_distance school_closure_popw national_lockdown testing_regime_* i.dow, vce(cluster t) a(adm1_id)
