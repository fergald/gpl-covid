...
// load data
insheet using data/processed/adm1/FRA_simulated-daily.csv, clear 
...
reghdfe D_l_cum_confirmed_cases school_closure_popw, absorb(i.adm1_id i.dow, savefe) cluster(t) resid  
est store base
